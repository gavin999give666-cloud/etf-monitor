"""
V6.2.3 Probability Calibration —— 概率校准模块（增强版）
========================================================
...
class ProbabilityCalibrator:
    ...
    def __init__(self, method='platt'):
        ...
        self.logloss_before = None   # V6.2.3
        self.logloss_after = None    # V6.2.3
        self.calibration_improved = None  # V6.2.3: 校准是否改善了指标
    ...
    def print_calibration_report(self):
        """V6.2.3: 打印校准报告（含Brier/LogLoss）"""
        print("\n" + "=" * 55)
        print("V6.2.3 Probability Calibration Report")
        print("=" * 55)
