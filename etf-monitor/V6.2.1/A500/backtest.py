...
class V6Backtest:
            ...
            if trade_info:
                if trade_info['action'] == 'BUY':
                    ...
                    if self.current_trade is not None:
                        ...
                        # V6.1: 记录交易结果到行为记忆库 (Replay Learning with Psychology)
                        if self.strategy is not None:
                            ...
                            # V6.1.1: 收集ML训练样本（统一 FeatureBuilder）
    ...
    def _compute_results(self):
        ...
        # V6.1: Expectancy (期望收益 per trade)
        if self.trades:
    ...
    def get_behavior_statistics(self):
        ...
        all_names = ['DoubleBottom', 'PanicSell', 'TrendPullback',
                     ...
                     'RSI_Overbought', 'MA_DeathCross']  # V6.1 新增
