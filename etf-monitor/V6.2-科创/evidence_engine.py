"""
V6.1 Evidence Engine —— 多源置信度融合引擎（稳定化版本）
==========================================================
...
架构：
    ...
    ├── Replay Confidence    —— V6.1升级，在线学习闭环
    ├── ML Confidence        —— V6.1启用，机器学习概率输出
    ├── Emotion Bonus        —— V5.5新增，多源情绪双确认加分
    └── Probability Calibration —— V6.1验证，校准评估
...
class EvidenceEngine:
    ...
    def __init__(self, weights=None, use_ml=False, use_replay=True):
        ...
        self.calibration_enabled = True  # V6.1: 校准开关
    ...
    def compute_final_confidence(self, event, market_context, current_date=None):
        ...
        # --- 5. Time Decay (V6.1修复：exp(-days/τ)) ---
        ...
        # V6.1: 构建完整证据分解（含 Explainability）
        evidence_breakdown = {
            'sources': evidence,
    ...
    def _compute_ml_confidence(self, event, market_context):
        """
        V6.1.1: 使用ML模型计算概率（统一 FeatureBuilder）
    ...
    def print_fusion_debug(self):
        ...
        print("\n" + "=" * 70)
        print("V6.1 Evidence Engine - 置信度融合明细 (Explainability)")
        print("=" * 70)
