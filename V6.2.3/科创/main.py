...
def main():
    print("=" * 60)
    print("  科创综指 ETF V6.2.3 Evidence Engine 稳定化版本")
    print("=" * 60)
    ...
    print("\n  请选择操作:")
    print("  1. V6.2.3 回测评估（Evidence Engine 稳定化版本）")
    print("  2. V6.2.3 今日信号（含Evidence分解）")
    print("  3. 更新数据")
